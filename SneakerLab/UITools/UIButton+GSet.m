...
@implementation UIButton (GSet)

- (void)setSelectedImage:(UIImage *)sImage andUnselectedImage:(UIImage *)uImage {
    [self setBackgroundImage:uImage forState:UIControlStateNormal];
...
- (void)setSelectedImageStr:(NSString *)sStr andUnselectImageStr:(NSString *)uStr {
    UIImage *img1 = [UIImage setImageWithName:sStr];
    UIImage *img2 = [UIImage setImageWithName:uStr];
    [self setSelectedImage:img1 andUnselectedImage:img2];
}
