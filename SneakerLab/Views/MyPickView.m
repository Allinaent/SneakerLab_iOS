...
@end
//#import "MyPickView.h"
//@interface MyPickView()<UIPickerViewDelegate, UIPickerViewDataSource>
//@property (weak,nonatomic)UIView *bgView;    //屏幕下方看不到的view
//@property (weak,nonatomic)UILabel *titleLabel; //中间显示的标题lab
//@property (weak, nonatomic) UIPickerView *pickerView;
//@property (weak,nonatomic)UIButton *cancelButton;
...
//{
//    MyPickView *pickerView = [[MyPickView alloc]initWithFrame:[UIScreen mainScreen].bounds  andTitle:title andHeadTitle:headTitle];
//    pickerView.callBack = callBack;
//    return pickerView;
//}
//
